...
/**
 * The founder film, housed as a "diagnostic viewport" (the film read like one of
 * the site's own instruments). A telemetry header, gold corner ticks, and a real
 * scrub timeline wrap a native 16:9 film that loops muted as an ambient preview;
 * the disc unmutes it, the expand control opens it full-screen. Telemetry is
 * honest film metadata only (title, runtime, elapsed) — the equalizer is a
 * decorative audio cue, not data.
 *
 * Extracted from the hero so it can sit wherever the founder's story belongs
 * (currently the "A New Era of Healthy Ageing" thesis section).
 */
